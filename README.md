...
<img width="1919" height="1022" alt="Screenshot 2026-02-07 140759" src="https://github.com/user-attachments/assets/ab6d505e-b644-4e93-8997-533bd89507ca" />

The above figure shows a detailed Praat TextGrid analysis of the utterance segment containing the word “mandatory”, aligned with its surrounding words “the” and “retirement”. The upper panel displays the speech waveform, where the selected region highlights the duration of the word mandatory, measured to be approximately 0.62 seconds. Below this, the spectrogram illustrates clear formant structures and voicing patterns across the word, indicating continuous vocal fold vibration during the vowel-dominated segments. The blue pitch contour remains stable around 170–175 Hz, suggesting consistent voicing and prosodic control during the articulation of the word. The TextGrid consists of two tiers: a word tier, where mandatory is accurately segmented as a single lexical unit, and a phone tier, where it is further divided into its constituent phonemes (e.g., /M AE N D AH T AO R IY/). The phone boundaries align well with visible changes in the waveform and spectrogram, such as energy transitions and formant shifts, confirming a good-quality forced alignment. Overall, this visualization demonstrates precise word and phone-level segmentation produced by MFA and verified using Praat, validating the temporal and phonetic accuracy of the alignment for this speech segment.
